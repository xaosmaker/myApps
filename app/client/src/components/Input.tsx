  ...
  return (
    <div className='relative  w-full'>
      <input
        ...
        {...register}
        placeholder=''
        className={`peer block w-full transform border-b-2  bg-transparent px-0 py-2.5 caret-slate-100 outline-none  ${error ? 'border-red-600 focus:border-red-600' : 'border-slate-800 focus:border-blue-600'}`}
        required={required}
      />
      <label
        htmlFor={name}
